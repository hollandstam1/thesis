...
```{r AICnewmodel}
#newmodel<- stepAIC(lmm_model, scope=list(upper= ~artist_gender*artist_race*artist_nationality_other*artist_ethnicity*moma_count_to_date*whitney_count_to_date*year, lower= ~1))
```

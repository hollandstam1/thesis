...
## 1.2 Why *Gardner's Art Through the Ages:*

### 1.2.1 Discourse of Authorship:
...
## 1.3 Why *Janson's History of Art*:
...
### **1.3.1 Discourse of Authorship Through Editions:**
...
`artist_race` = I recorded the race of the artist as listed by the text. I categorized race based on the guidelines of the US Census.[^chapter1-22] In the case the race of the artist was not listed, I would do a quick google search to further research their race. If I couldn't find their race, I listed such as N/A.

[^chapter1-22]: https://www.census.gov/topics/population/race/about.html.
...
`artist_ethnicity` = I recorded the ethnicity of the artist as listed by the text. Similarly to race, I categorized ethnicity based on the guidelines of the US Census.[^chapter1-23] In the case the ethnicity of the artist was not listed, I would do a quick google search to further research their ethnicity. If I couldn't find their ethnicity, I listed such as N/A.

[^chapter1-23]: https://www.mobap.edu/wp-content/uploads/2013/01/US-Census-Bureau-Definitions-of-Race-and-Ethnicity.pdf#:\~:text=Definition%3A%20The%20U.S.%20Census%20Bureau%20adheres%20to%20the,Hispanics%20and%20Latinos%20may%20be%20of%20any%20race.
...
Pivoting to joining The Whitney's catalog history and the MoMA's catalog history with the data set I just created with both Janson and Gardner observations, I had to create a variable called `whitney_count_to_date` and `moma_count_to_date` respectively. This is because as the publication year of books changes through time, the amount of exhibitions that are given to an artist has the possibility to change through time as well.
...
### 4.3.1 Data Preparation for Modeling Purposes:
...
# 5.0 Exploratory Data Analysis: *Gardner's Art Through the Ages* and *Janson's History of Art* Through Editions

## **5.1 Count Through Editions:**
...
![](https://lh6.googleusercontent.com/-fxCinylYYA8sB2zbAHmHqqUqxQ26KdZHZgPvNBfgKfWMZqCVK_-VZk2SKqToScRwccJ1ynxTJuI_w2lp0N2BmvgfLPEWl0LO4Ll84ljfkyBkCMQwU8WH-HDC7MXBZpMstMMA8ff)
...
## **5.4 Ethnicity Through Editions:**
...
## **5.5 Nationality Through Editions:**
...
# 6.0 Exploratory Data Analysis: *Janson's History of Art* and *Gardner's Art Through the Ages vs.* Total Space Ratio per Page per Artist per Edition `space_ratio_per_page_total`

## 6.1 Distribution of `space_ratio_per_page_total`
...
## 6.2 `space_ratio_per_page_total` vs. `artist_gender`
...
## 6.3 `space_ratio_per_page_total` vs. `artist_race`
...
## 6.4 `space_ratio_per_page_total` vs. `artist_ethnicity`
...
## 6.5 `space_ratio_per_page_total` vs. `artist_nationality_other`
